...
train_data, test_data = train_test_split([0.8,0.2],cols,seed=0,start_date=start_date,end_date=end_date, cpu_eff_cut = -1000)

train_data.loc[:,features] = minmax_scaler(train_data.loc[:,features], "/home/kyang/master_grid/ml/model/model_weights_no_cpu_eff")

test_data.loc[:,features] = minmax_scaler(test_data.loc[:,features], "/home/kyang/master_grid/ml/model/model_weights_no_cpu_eff",True)
...
train_model(path="/home/kyang/master_grid/ml/model/model_weights_no_cpu_eff")
